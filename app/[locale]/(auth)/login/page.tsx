  ...
  return (
    <>
      <div className="text-center">
        ...
        <h1 className="mt-3 text-xl font-semibold sm:text-2xl">{t('loginTitle')}</h1>
      ...
      <p className="mt-6 text-center text-sm text-[var(--color-muted)]">
        {t('noAccount')}{' '}
        <Link href="/register" className="ml-1 font-semibold text-[var(--color-primary)] transition hover:opacity-80 sm:ml-2">
          {t('createOne')}
        </Link>
      </p>
    </>
