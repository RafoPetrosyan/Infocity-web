...
export default function Home() {
  ...
  const testImages = ['/00a529f4a75bf5586c0810c4dc7941c0a8ece2e7.jpg', '/7a6be63614de24d5d217ac0b4c888512d27f144e.jpg'];
              ...
              <div className="space-y-3 p-6">
                ...
                {isEvent(featuredItem) && featuredItem.friendsCount && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-[var(--color-muted)]">+{featuredItem.friendsCount} friends</span>
                  </div>
                )}
            ...
            {compactItems.map((item) => (
              ...
              >
                  ...
                  <div className="absolute left-4 top-4 flex gap-2 text-xs font-semibold text-white">
                    ...
                    {(isPlace(item) || isBusiness(item)) && (
                      <>
                        ...
                        {item.rating && <span className="rounded-full bg-black/45 px-3 py-1">★ {item.rating}</span>}
                      </>
                    )}
                  </div>
                  <button
                ...
                <div className="space-y-2 p-5">
                  ...
                  {isBusiness(item) && item.hours && <p className="text-xs text-[var(--color-muted)]">{item.hours}</p>}
                </div>
              </article>
            ))}
          </div>
